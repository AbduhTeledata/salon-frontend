        ...
        toPng(dom)
          .then((dataUrl) => {
            ...
            img.onload = () => {
              ...
              // Output / Save
              pdf.save(`invoice-${invoiceInfo.inv_code}.pdf`);
            };
          })
          .catch((error) => {
              ...
              <div className="p-4" id="print">
                ...
                <div className="mt-6">
                  <div className="mb-4 grid grid-cols-2">
                    ...
                    <span>{invoiceInfo.inv_code}</span>
                    <span className="font-bold">Kasir:</span>
                    <span>{invoiceInfo.branchId}</span>
                    <span className="font-bold">Customer:</span>
                    <span>{invoiceInfo.kodemember}</span>
                  </div>
                  ...
                  <div className="mt-4 flex flex-col items-end space-y-2">
                    ...
                    <div className="flex w-full justify-between">
                      ...
                      <span>Rp.{invoiceInfo.total_disc}</span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Ppn:</span>
                      <span>Rp.{invoiceInfo.taxes}</span>
                    </div>
                    <div className="flex w-full justify-between border-t border-black/10 py-2">
                      <span className="font-bold">Total:</span>
                      <span className="font-bold">
                        Rp.
                        {invoiceInfo.totalHarga % 1 === 0
                          ? invoiceInfo.totalHarga
                          : invoiceInfo.totalHarga}
                      </span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Keterangan:</span>
                      <span>{invoiceInfo.note}</span>
                    </div>
                  </div>
                </div>
              </div>
