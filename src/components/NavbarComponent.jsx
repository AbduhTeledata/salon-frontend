...
const NavbarComponent = () => {
  ...
  return (
    ...
    <div>
      <nav
        className="flex-no-wrap relative flex w-full items-center justify-between bg-blue-600 my-0 py-0 shadow-md shadow-black/5 dark:bg-neutral-800 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4"
        data-te-navbar-ref>
        <div className="flex w-full flex-wrap items-center justify-between px-3">
          ...
          <div
            ...
            {/* <!-- Logo --> */}
            <a
              className="mb-4 mr-2 mt-3 flex items-center text-white hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0"
              href="/dashboard">
              <img
                src={logo}
                width="30"
                ...
                alt="Kyoshi logo"
              /> {''}
              <strong>Kyoshi Beauty</strong>
            </a>
            {/* <!-- Left navigation links --> */}
            {/* <ul
              className="list-style-none mb-2 mr-auto flex flex-col pl-0 lg:flex-row"
              data-te-navbar-nav-ref>
              <li className="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref> */}
                {/* <!-- Dashboard link --> */}
                {/* <a
                  className="text-neutral-800 hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-zinc-400"
                  href="/dashboard"
